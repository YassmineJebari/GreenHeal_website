...
if (
    ...
    isset($_POST["MenuEvent"]) &&
    isset($_POST["Prix"]) &&
	isset($_POST["Promotion"]) &&
    isset($_POST["type"]) &&
    isset($_POST["PhotoMenu"])
    ...
    if (
        ...
        $MenuC->updateMenu($Menu, $_POST["IDMenu"]);     
...
<body
    ...
    if (isset($_POST['IDMenu'])) {
        $Menu = $MenuC->showMenu($_POST['IDMenu']);

    ?>

                            <form role="form text-left" method="POST" action="ViewMenu.php">
                                <input
                                    ...
                                    type="submit" name="update" value="View Menu">
                            ...
                            <form role="form text-left" method="POST" name="inscription" action="">
                                ...
                                <div class="mb-4">
                                    <input type="text" name="IDMenu" id="IDMenu"
                                        ...
                                        placeholder="IDMenu*" value="<?php echo $Menu['IDMenu']; ?>" />

                                </div>

                                <div class="mb-4">
                                    <input type="text" name="NomMenu" id="NomMenu"
                                        class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                        placeholder="Product Name*" value="<?php echo $Menu['NomMenu']; ?>" onkeyup="nameValidation()" />
                                ...
                                <div class="mb-4">
                                    <input id="Description" name="Description" type="text"
                                        class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                        placeholder="Description*" value="<?php echo $Menu['Description']; ?>" onkeyup="DescriptionValidation()"   />
                                ...
                                <div class="mb-4">
                                    <input type="text" name="type" id="type"
                                        class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                        placeholder="type*" value="<?php echo $Menu['type']; ?>"  />
                                ...
                                <div class="mb-4">
                                    <input type="text" id="Prix" name="Prix"
                                        class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                        value="<?php echo $Menu['Prix']; ?>" placeholder="Prix*" onkeyup="PrixValidation()">
                                        <p style="color: red" id="PrixEr"></p>

                                </div>

                                <div class="mb-4">
                                    <input type="text" name="MenuEvent" id="MenuEvent"
                                        class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                        placeholder="MenuEvent" value="<?php echo $Menu['MenuEvent']; ?>" />
                                ...
                                <div class="mb-4">
                                    <input type="number" name="Promotion" id="Promotion"
                                        class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                        placeholder="Promotion *" aria-label="Name"
                                        value="<?php echo $Menu['Promotion']; ?>" onkeyup="PromotionValidation()"/>
                                        <p style="color: red" id="PromotionEr"></p>
                                </div>
                                ...
                                <div class="text-center">
                                    <div>
                                        ...
                                        <i  onclick="document.getElementById('PhotoMenu').click();"></i>
                                    
                                    </div>

                                    <input id="PhotoMenu" name="PhotoMenu" type="file" style="display: none;"   value="<?php echo $Menu['PhotoMenu']; ?>" />
                                    <input type="button"
                                        class=" px-16 py-3.5 mt-6 mb-2 font-bold text-center text-white align-middle transition-all bg-transparent border-0 rounded-lg cursor-pointer active:opacity-85 hover:-translate-y-px hover:shadow-xs leading-normal text-sm ease-in tracking-tight-rem shadow-md bg-150 bg-x-25 bg-gradient-to-tl from-zinc-800 to-zinc-700 hover:border-slate-700 hover:bg-slate-700 hover:text-white"
                                        value="<?php echo $Menu['PhotoMenu']; ?>"
                                        onclick="document.getElementById('PhotoMenu').click();" />
