...
if (isset($_SESSION['user'])){
  ...
  $statementww = $gateway->getEvents();

  if(isset($_GET['eventID']))
  $eventID=$_GET['eventID'];
  $statement = $gateway->getEventsById($eventID);
                    ...
                    <div class="form-reservations-box">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="text-center ">
                                ...
                                <?php
foreach ($statementww as $Event) {
?>
                                <label id="evenement " name="evenement ">ID#<?= $Event['EventID']; ?></label>
...
?>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-box">
                                    <input class="form-control" type="text" id="nom" name="nom"
                                        placeholder="Entrer votre nom" onfocusout="majus_titre()" Required>
                                </div>   </div>
                                <label id="element1" name="erreur" style="color: red;display: none;">Le nom doit
                                    commencer
                                    par une majuscule </label>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-box">
                            <input class="form-control" type="text" id="evenement" name="evenement"
                                placeholder="Enter ID Event for reservation" onfocusout="prof2()" Required>
                        </div>       </div>
                        <label id="element2" name="erreur" style="color: red;display: none;">Veuillez choisir l
                            event </label>
                        ...
                        <!-- end col -->
                        <input type="submit" class="btn btn-primary pull-right" value="Ajouter" name="ajouter">
