        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group">
                    <input class="form-control" type="text" id="nom" name="nom" placeholder="Entrer votre nom" onfocusout="majus_titre()" Required>
                </div>
                <label id="element1" name="erreur" style="color: red;display: none;">Le nom doit commencer par une majuscule </label>
                            ...
                            event:
                <div class="form-group">
                    <input class="form-control" type="text" id="evenement" name="evenement" placeholder="Entrer l event a reserver" onfocusout="prof2()" Required>
                </div>
                <label id="element2" name="erreur" style="color: red;display: none;">Veuillez choisir l event </label>
