  ...
  echo $_POST['PhotoMenu'];*/ ?>!-->
                            ...
                            <form role="form text-left" method="POST" name="inscription" action="">
                                <div class="mb-4">
                                    <input type="text" name="NomMenu" id="NomMenu"
                                        ...
                                        placeholder="Product Name*" aria-label="Name" onkeyup="nameValidation()" />
                                ...
                                <div class="mb-4">
                                    <textarea id="Description" name="Description" type="text"
                                        class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                        placeholder="Description*" onkeyup="DescriptionValidation()"></textarea>
                                ...
                                <div class="mb-4">
                                    <input type="text" id="Prix" name="Prix"
                                        class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                        placeholder="Prix*" onkeyup="PrixValidation()">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="MenuEvent" name="MenuEvent"
                                        class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow">
                                        <option value="0">MenuEvent</option>
                                        <option value="none">none</option>
                                        <option value="Halloween">Halloween</option>
                                        <option value="Christmas ">Chritsmas</option>
        ...
        ?>
                                <div class="flex  my-4">
                                    ...
                                    <input type="checkbox" id="iding" name="iding" value="<?= $Ing['iding']; ?>" />
                                    <label for="iding"><?= $Ing['noming']; ?></label>
                                </div>
                                <?php
        }
        ?>
                                ...
                                <div class="mb-4">
                                    <input type="number" name="Promotion" id="Promotion"
                                        class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                        placeholder="Promotion *" aria-label="Name" onkeyup="PromotionValidation()" />
                                ...
                                <div class="text-center">
                                    <div class="tm-product-img-dummy mx-auto">
                                        <i class="fas fa-cloud-upload-alt tm-upload-icon"
                                            onclick="document.getElementById('PhotoMenu').click();"></i>
                                        <p style="color: red" id="fileEr"></p>
                                    </div>

                                    <input id="PhotoMenu" name="PhotoMenu" type="file" style="display: none;" />
                                    <input type="button"
                                        class=" px-16 py-3.5 mt-6 mb-2 font-bold text-center text-white align-middle transition-all bg-transparent border-0 rounded-lg cursor-pointer active:opacity-85 hover:-translate-y-px hover:shadow-xs leading-normal text-sm ease-in tracking-tight-rem shadow-md bg-150 bg-x-25 bg-gradient-to-tl from-zinc-800 to-zinc-700 hover:border-slate-700 hover:bg-slate-700 hover:text-white"
                                        value="UPLOAD PRODUCT IMAGE" accept=".png, .jpg, .jpeg"
        ...
        document.forms["inscription"].addEventListener("submit", function(e) {
            ...
            "")); // reinitialiser l'affichage des erreurs
