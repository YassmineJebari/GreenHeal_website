                    ...
                    <div
                        ...
                        <table
                            ...
                            <tr>
                                ...
                                <th
                                    class="px-1 py-1 font-bold text-left uppercase align-middle bg-transparent border-b border-collapse shadow-none dark:border-white/40 dark:text-white text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                                    type</th>
        ...
        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="Updateing.php"><i
                                            class="mr-2 fas fa-pencil-alt text-slate-700" aria-hidden="true">
                                            <input
                                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent hover:-translate-y-px active:opacity-85 bg-x-25 bg-clip-text"
                                                type="submit" name="update" value="Update">
                                            <input type="hidden" value=<?PHP echo $Ing['iding']; ?> name="iding"></i>
                                    </form>
                                </td>
                                <td>
                                   
                                    <a class="relative z-10 inline-block px-4 py-2.5 mb-0 font-bold text-center text-transparent align-middle transition-all border-0 rounded-lg shadow-none cursor-pointer leading-normal text-sm ease-in bg-150 bg-gradient-to-tl from-red-600 to-orange-600 hover:-translate-y-px active:opacity-85 bg-x-25 bg-clip-text"
                                            href="deleteing.php?iding=<?php echo $Ing['iding']; ?>"><i
