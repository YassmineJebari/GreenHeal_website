            ...
            <div class="banner-static">
                ...
                <div class="page-inner-nav w-100 mb-4 d-inline-flex justify-content-center align-items-center">
                    <div class="w-100 tracking-in-expand-fwd banner-text">
                        ...
                        <a href="menu.php">Menu</a> <span> | </span>
                    ...
                    <div class="row menu-item-container align-items-center mx-auto mb-4 p-3">
                        ...
                        <div class="px-0 mt-1 col-sm-3 col-12">
                            ...
                            <img class="menu-item-img mx-auto d-block"
                                src="../contents/images/category-items/main-menu/<?= $Menu['PhotoMenu']; ?>"
                                alt="main-menu item image"></a>
                        </div>

                        <div class="text-center text-sm-start mt-6 col-12  col-sm-9 ps-md-4">

                            <a href="Viewproduct.php?IDMenu=<?=$Menu['IDMenu'] ?>" class="inner-nav-active">
                                <h3 class="menu-item-title mb-0 mt-1 text-capitalize"> <?= $Menu['NomMenu']; ?></h3>
                            </a>
                            <div class="menu-item-price"> <?= $Menu['Prix']; ?> DT </div>
                            <h5 class="center mt-1 mt-sm-1 w-100">
                                <?= $Menu['Description']; ?>
                            </h5>
                            <button class="add-to-cart d-inline-block text-center text-capitalize" role="button">
                            <a href="../views/panier/add_panier.php?user_id=<?php  echo $user_id; ?>&commande_id=<?php  echo $Menu['IDMenu']; ?>">
   <a href="../views/panier/add_panier.php?user_id=<?php  echo $user_id; ?>&commande_id=<?php  echo $Menu['IDMenu']; ?>">
                        Add To Cart</a>
