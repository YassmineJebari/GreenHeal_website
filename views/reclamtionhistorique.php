...
$rechis = $reclamtionC->listrechistorique($user_id);
$recrep = $reclamtionC->listrechistoriquerep($user_id);
...
<body>
    ...
    <section class="panierCart_section" style="padding-bottom: 10rem;">
        ...
        <h1 class="cart_panier_title">History</h1>
            <a href="./respondhistorique.php" class="cart_panier_Historique-btn">Responses</a>
        </div>
        <table id="exampless"
            ...
            <tbody>
                ...
                <td
                    ...
                    <p class="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-80"
                        ...
                        <?php echo $rec['prenom'] ?> <?php echo $rec['nom'] ?>
                    </p>
                </td>
                <td
                    class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                ...
                <td class="p-2 text-sm leading-normal text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"
                    ...
                    <p class="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-80"
                        ...
                        <?php echo $rec['type_of_reclamation'] ?>
                    </p>
                </td>
                <td class="p-2 text-sm leading-normal text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"
                    style="text-align:left;">
                ...
                <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"
                    style="text-align:left">
                    <a href="deleterec.php?id=<?php echo $rec['id'] ?>"
