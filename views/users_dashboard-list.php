...
if(isset($_GET['search'])){
  $userList =$userC->searchUsers($_GET['search']);
}
else if(isset($_GET['filter'])){
  $userList =$userC->filterUsers($_GET['filter']);
}
else{
  $userList =$userC->afficher_users(); 
}
...
<head>
    ...
    /* .paginate_button:hover{
        background: #03bf8a !important; 
      }
     */
    </style>
    <link href="../contents/css/user.css" rel="stylesheet" />
</head>
            ...
            <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                ...
                <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                    <div class="flex items-center md:ml-auto md:pr-4">
                        <form method="GET" action="users_dashboard-list.php"
                ...
                <div class="flex-none w-full max-w-full px-3">
                    <div
                        ...
                        <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                            <form method="GET" action="users_dashboard-list.php" style="display:flex;">
                                <h6 class="dark:text-white">Users List</h6>
                                <h6 class="dark:text-white" style="padding-left: 47rem;padding-right:1rem">Filter</h6>

                                <input placeholder="Select Role" list="role" name="filter"
                                    class="list-role-dash-admin" />
                                <datalist id="role">
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <div class="flex px-2 py-1">
                                                    <div>
                                                        <img src="./user/uploads/<?php echo $list['img_url'] ?>"
                                                            class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-in-out h-9 w-9 rounded-xl"
                                                            alt="user1" />
                                                    </div>
                                                    <div class="flex flex-col justify-center">
                                                        <h6 class="mb-0 text-sm leading-normal dark:text-white">
                                                            <?php echo $list['nom'];echo " ";echo $list['prenom'] ?>
                                                        </h6>
                                                        <p
                                            ...
                                            <td style="text-align: left;"
                                                ...
                                                <span
                                                    class="from-emerald-500 to-teal-400 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white"
                                                    style="background-color: #03bf8a; padding-top: 7px">Active</span>
                                                <?php } ?>
                                                <?php if($list['status'] ==0){  ?>
                                                <span
                                                    class="from-emerald-500 to-teal-400 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white"
                                                    style="background-color: #DC284C; padding-top: 7px">Inactive</span>
                                                <?php } ?>
                                            </td>
                                            <td style="text-align: left;"
                                                class="p-2 text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400"><?php echo $list['phone'] ?></span>
                                            </td>
                                            <td
                                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                <a href="user_dashboard-profile.php?user_id=<?php echo $list['user_id'] ?>"
                                            ...
                                            <td
                                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                <a href="./user/block_unblock.php?user_id=<?php echo $list['user_id'] ?>"
                                                    class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400"><i
                                                        class='fas fa-hammer'>
                                                        <?php if($list['status']==1 ){ ?>
                                                        Ban
                                                        <?php }else{ ?>
                                            ...
                                            <td
                                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                <a href="./user/delete_user.php?user_id=<?php echo $list['user_id'] ?>"
