...
$userC = new UserC();
$listeUsers = $userC->recuperer_user($_GET['user_id']);
...
<body
    ...
    <div class="relative h-full max-h-screen transition-all duration-200 ease-in-out xl:ml-68">
      ...
      ?>
        <form method="POST" action="./user/update_user.php?user_id=<?php echo $list['user_id']; ?>"
        ...
        <div fixed-plugin-card
            ...
            <div class="flex-auto p-6 pt-0 overflow-auto sm:pt-4">
                ...
                <div class="mt-4">
                    ...
                    <p class="leading-normal dark:text-white dark:opacity-80 text-sm">
                ...
                <p class="block mt-2 leading-normal dark:text-white dark:opacity-80 text-sm xl:hidden">
