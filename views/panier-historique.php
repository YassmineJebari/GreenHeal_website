...
$panierC = new PanierC();
$panierList = $panierC->getAllOrdersDatesHistorique($user_id);
...
<link rel="stylesheet" href="../contents/css/panier.css" />
  ...
  <body>
    ...
    <section class="panierCart_section"  style="padding-bottom: 10rem;">
      <h1 class="cart_panier_title">Historiques</h1>
      ...
      <table id="example"
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td
                          ...
                          style="text-align:left"
                          >
                          <a href="panier-historique.php?date=<?php echo $list['date_checkout'] ?>"
                        ...
                        <td
                          ...
                          style="text-align:left"
                          >
                        <a href="./panier/delete_order.php?date=<?php echo $list['date_checkout'] ?>"
                            class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400 command__list-Btn"
                            style="font-size:1.5rem"
                            >Delete</a
                          >
                  ...
                  <!---------------------------Details order----------------------------------->
                  <div class="order__details-modelH" <?php if(!isset($_GET['date'])){ ?> style="display: none;" <?php } ?> >
                        <div class="order__details-model-v1H">
                        <a href="panier-historique.php" class="close_btn-checkout" style="display:block;margin-bottom: 1rem;">Close</a>
                       

                          <table id="examples" class="hover items-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                            <thead class="align-bottom">
                              <tr style="font-size: 2rem;">
                            ...
                            <!-------------------------------------------------------------------------------------------->
                              ...
                              ?>
                              <tr style="font-size: 1.5;">
                                <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                  <div class="flex px-2 py-1" style="display:flex">
                                    <div>
                                      <img style="width: 8rem;height:6rem"
                                      src="../contents/images/category-items/main-menu/<?php  echo $commande['PhotoMenu']; ?>"
                                        class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-in-out h-16 w-16 rounded-xl"
                                        alt="user1"
                                      />
                                    </div>
                                    <div class="flex flex-col justify-center">
                                      <h6
                                        class="mb-0 text-sm leading-normal dark:text-white"
                                        style="font-size:1.5;position:relative;top:2rem;left:2rem"
                                      >
                                ...
                                >
                                  ...
                                  ><?php echo $commande['Prix']*$commande['nb_commande'] ?></a>
                                </td>
