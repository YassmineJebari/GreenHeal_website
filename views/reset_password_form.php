...
<html lang="en">
  ...
  <body>
    ...
    <section class="signup_section">
      ...
      <form method="POST" id="login" action="./user/change_password.php?email=<?php echo $_GET['email'] ?>&token=<?php echo $_GET['token'] ?>" class="signup_section-right">
        <div class="signup__container" style="min-height: 5rem;">
          <h1 class="signup__heading">Change Password</h1>
          <!---------------------------Form input Password---------------------------------------->    
          ...
          <!---------------------------end form---------------------------------------------------->
          <input class="primary-btn-form" type="submit" value="Update" />
