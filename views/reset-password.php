...
<html lang="en">
  ...
  <body>
    ...
    <section class="signup_section">
      ...
      <form method="POST" id="login" action="./user/reset.php" class="signup_section-right">
        <div class="signup__container" style="min-height:10rem">
          <h1 class="signup__heading">Reset your password</h1>
          <!---------------------------Form input email---------------------------------------->
          ...
          <!---------------------------end form---------------------------------------------------->
          <input class="primary-btn-form" type="submit" value="Send" />
