...
include_once('../controllers/function2.php');
    ...
    <main class="relative h-full max-h-screen transition-all duration-200 ease-in-out xl:ml-68 rounded-xl">
                ...
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        <li class="text-sm leading-normal">
                            <a class="text-white opacity-50" href="#">Pages</a>
                        </li>
        ...
        <div class="w-full px-6 py-6 mx-auto">
                            ...
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-2 font-bold dark:text-white"><?php echo $userC->totalClients1()?>
                                        </h5>
                            ...
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-2 font-bold dark:text-white"><?php echo $userC->totalChef() ?>
                                        </h5>
                                ...
                                <div class="px-3 text-right basis-1/3">
                                    <div
                                        class="inline-block w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-red-600 to-violet-500">
                                        <i class=" fa fa-bell text-lg relative top-3 text-white"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-2 font-bold dark:text-white"><?php echo $eventC->totalevent() ?>
                                        </h5>
                                    </div>
                                </div>
                                <div class="px-3 text-right basis-1/3">
                            ...
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-2 font-bold dark:text-white"><?php echo $userC->totalLivreur()?>
                                        </h5>
                                    </div>
                                </div>
                                <div class="px-3 text-right basis-1/3">
                                    <div
                                        class="inline-block w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-emerald-500 to-orange-600">
                                        <i
                                            class="ni leading-none ni ni-box-2 relative text-lg relative top-3.5 text-white"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-2 font-bold dark:text-white">
                                            <?php echo $reclamationC->totalReclamtions()?></h5>
                                    </div>
                                </div>
                                <div class="px-3 text-right basis-1/3">
                                    <div
                                        class="inline-block w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-blue-500 to-teal-400">
                                        <i
                                            class="ni leading-none ni ni-tag relative text-lg relative top-3.5 text-white"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-2 font-bold dark:text-white"><?php echo $menuC->totalMenu()?></h5>
                                    </div>
                                </div>
                                <div class="px-3 text-right basis-1/3">
                                    <div
                            ...
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-2 font-bold dark:text-white">
                                            <?php echo $PanierC->totalCommands()?></h5>
                                    </div>
                                </div>
                                <div class="px-3 text-right basis-1/3">
                                    <div
            ...
            <div style="display:flex;">
                ...
                <div class=" mt-6 -mx-3" style="width: 50rem;margin-right:2.5rem !important;margin-left:0rem">
                    <div class="">
                        <div
                            class="border-black/12.5 dark:bg-slate-850 dark:shadow-dark-xl shadow-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
                            <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid p-6 pt-4 pb-0">
                                <h6 class="capitalize dark:text-white">Clients overview</h6>
                ...
                <div class=" mt-6 -mx-3" style="width: 50rem;margin-right:2.5rem !important;margin-left:0rem">
                    <div class="">
                        <div
                            class="border-black/12.5 dark:bg-slate-850 dark:shadow-dark-xl shadow-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
                            <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid p-6 pt-4 pb-0">
                                <h6 class="capitalize dark:text-white">Orders overview</h6>
                                <p class="mb-0 text-sm leading-normal dark:text-white dark:opacity-60">
                                </p>
                            </div>
                            <div class="flex-auto p-4">
                        ...
                        <div class="w-full max-w-full px-3 mt-0 mb-6 shrink-0 lg:mb-0 lg:w-1/2 lg:flex-none">
                            <div class="text-sm leading-normal text-center text-slate-500 lg:text-left">
                                ...
                                <a href="https://www.creative-tim.com"
                                    class="font-semibold text-slate-700 dark:text-white" target="_blank">Dawn_group</a>
                                for a better web.
                            </div>
                        </div>
...
<!-- plugin for charts  -->
  ...
  <script src="../contents/assets/js/plugins/chartjs.min.js" async></script>
  <!-- plugin for scrollbar  -->
  <script
    src="../contents/assets/js/plugins/perfect-scrollbar.min.js"
    async
  ></script>
  <!-- main script file  -->
    ...
    new Chart(ctx1, {
        ...
        data: {
            ...
            datasets: [{
                ...
                fill: true,
                data: [
                    <?php echo $userC->totalClients(1) ?>,
                    <?php echo $userC->totalClients(2) ?>,
                    <?php echo $userC->totalClients(3) ?>,
                    <?php echo $userC->totalClients(4) ?>,
                    <?php echo $userC->totalClients(5) ?>,
                    <?php echo $userC->totalClients(6) ?>,
                    <?php echo $userC->totalClients(7) ?>,
                    <?php echo $userC->totalClients(8) ?>,
                    <?php echo $userC->totalClients(9) ?>,
                    <?php echo $userC->totalClients(10) ?>,
                    <?php echo $userC->totalClients(11) ?>,
                    <?php echo $userC->totalClients(12) ?>,
                ],
                maxBarThickness: 6,
            }, ],
        },
    ...
    new Chart(ctx1, {
        ...
        data: {
            ...
            datasets: [{
                ...
                fill: true,
                data: [
                    <?php echo $panierC->totalOrders(1) ?>,
                    <?php echo $panierC->totalOrders(2) ?>,
                    <?php echo $panierC->totalOrders(3) ?>,
                    <?php echo $panierC->totalOrders(4) ?>,
                    <?php echo $panierC->totalOrders(5) ?>,
                    <?php echo $panierC->totalOrders(6) ?>,
                    <?php echo $panierC->totalOrders(7) ?>,
                    <?php echo $panierC->totalOrders(8) ?>,
                    <?php echo $panierC->totalOrders(9) ?>,
                    <?php echo $panierC->totalOrders(10) ?>,
                    <?php echo $panierC->totalOrders(11) ?>,
                    <?php echo $panierC->totalOrders(12) ?>,
                ],
                maxBarThickness: 6,
            }, ],
        },
